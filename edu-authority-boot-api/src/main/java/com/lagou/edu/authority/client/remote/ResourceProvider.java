...
import com.lagou.edu.authority.client.dto.AllocateRoleResourceDTO;
import com.lagou.edu.authority.client.dto.ResourceCategoryDTO;
import com.lagou.edu.authority.client.dto.ResourceCategoryNodeDTO;
import com.lagou.edu.authority.client.dto.ResourceDTO;
import com.lagou.edu.authority.client.param.ResourceQueryParam;
import com.lagou.edu.authority.client.remote.fallback.ResourceProviderFallbackFactory;
 ...
 *
 * @author : chenrg
 * @create 2020/7/10 19:12
 **/
@Component
@FeignClient(name = "edu-authority-boot", path = "/resource",
