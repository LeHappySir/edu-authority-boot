...
import com.lagou.edu.authority.client.dto.MenuDTO;
import com.lagou.edu.authority.client.dto.MenuNodeDTO;
import com.lagou.edu.authority.client.param.MenuQueryParam;
import com.lagou.edu.authority.client.remote.fallback.MenuProviderFallbackFactory;
 ...
 **/
@Component
@FeignClient(name = "edu-authority-boot", path = "/menu",
